...
public class PlusTimeController {
    ...
    @FXML
    void PlusTimeClicked(MouseEvent event) {
        ...
        try {
            ...
            _Error.setText("Value is not Corrected OR The TimeType isn't specified");
        }
        try {
            HelloApplication.getInstance().getShop().PlusTimeOfAllWatches(vt, value_int);
